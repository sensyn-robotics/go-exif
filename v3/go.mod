...
require (
	github.com/dsoprea/go-exif/v2 v2.0.0-20200711180620-208788de2815 // indirect
...
replace (
	...
	github.com/dsoprea/go-exif/v2/common => ./common
	github.com/dsoprea/go-exif/v2/undefined => ./undefined
)
